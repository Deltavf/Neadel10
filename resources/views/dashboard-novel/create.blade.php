              ...
              <form action="/dashboard/novel" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="title" id="title" value="{{ old('title') }}" class="form-control"
                    placeholder="Novel title" required>
                ...
                <div class="form-group">
                  ...
                  <select name="status" id="status" class="form-control" required>
                    ...
                    <option value="Ongoing" @if(old('status')=='Ongoing' ) selected @endif>Ongoing
                    </option>
                  ...
                  <div class="form-check ms-1">
                    <div class="row" required>
                      ...
                      <div class="col-md-3 col-6">
                        <input class="form-check-input" type="checkbox" value="{{ $genre->id }}" id="{{ $genre->id }}"
                          name="genre[]" @if(old('genre')) @foreach(old('genre') as $oldGenre)
                          @if($oldGenre==$genre->id)
