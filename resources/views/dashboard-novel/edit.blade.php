              ...
              <form action="/dashboard/novel/{{ $novel->slug }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="title" id="title" value="{{ old('title', $novel->title) }}"
                    class="form-control" placeholder="Novel title" required>
                ...
                <div class="form-group">
                  ...
                  <select name="status" id="status" class="form-control" required>
                    ...
                    <option value="Ongoing" @if(old('status', $novel->status) == 'Ongoing') selected
                      @endif>Ongoing</option>
                    <option value="End" @if(old('status', $novel->status) == 'End') selected
                      @endif>End</option>
                  </select>
