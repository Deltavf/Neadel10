    ...
    <div class="col-12">
      <div class="card mb-4">
        <div class="card-header pb-0">
          <h6 class="d-inline">Novel | </h6><a href="/dashboard/novel/create" class="text-sm text-dark">Create Novel</a>
        ...
        <div class="card-body px-0 pt-0 pb-2">
          <div class="table-responsive p-0">
                ...
                <tr>
                  ...
                  <td class="align-middle">
                    ...
                    <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4"
                      ...
                      <li>
                        <a class="dropdown-item border-radius-md" href="/dashboard/novel/{{ $novel->slug }}/volume">Add
                          Volume</a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a class="dropdown-item border-radius-md"
                          href="/dashboard/novel/{{ $novel->slug }}/edit">Edit</a>
                      </li>
                      <li>
            ...
            @else
            <p class="text-center mt-4">No Novels.</p>
            @endif
          </div>
