    ...
    <div class="col-12">
      <div class="card mb-4">
        <div class="card-header pb-0">
          <h6 class="d-inline">Genre | </h6><a href="/dashboard/genre/create" class="text-sm text-dark">Tambah data</a>
          <div style="float: right;">
            ...
            {{-- <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="filterButton">
              <li>
                <a class="dropdown-item border-radius-md" href="">Urutkan genre terbaru</a>
              </li>
              <li>
                <a class="dropdown-item border-radius-md" href="">Urutkan genre Terlama</a>
              </li>
            </ul> --}}
          </div>
        </div>
